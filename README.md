...
- [Flowbite](https://flowbite.com/): Biblioteca de código abierto de componentes de interfaz de usuario basada en el marco Tailwind CSS.
...
Tras esto, los siguientes pasos que sugiere **_Netlify_** son configurar nuestro propio dominio web y securizar el mismo con HTTPS.
